...
function visualize!(env::BasicCarEnvironment, model::NeuralNetwork.AbstractNeuralNetwork, reset::Bool = true; car_image_path::String, map_image_path::String, fps::Int = 60, log::Bool = false)
    if reset
        reset!(env)
    end
