...
# import .ES
# ES.gif_save(:CMAES, (;sigma=0.7f0, lambda_n=30), :dropwave, "log/test.gif")
# ES.gif_save(:DE, (;sigma=1f0, parents_n=100, f_param=0.8f0, cross_param=0.8f0, base_mode=:best), :rastrigin, "log/test.gif")
# ES.gif_save(:ARS, (;sigma=1f0, step_size=2f0, child_n=100, best_n=50), :dropwave, "log/test.gif")
